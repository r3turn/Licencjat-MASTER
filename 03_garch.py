...
plt.savefig("charts/03_garch/forecast_vs_realized_all.png", dpi=150, bbox_inches='tight')
plt.close()
...
print(f"Wykres zbiorczy: charts/03_garch/forecast_vs_realized_all.png")
